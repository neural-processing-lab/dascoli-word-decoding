...
class SubmititMixin(pydantic.BaseModel):
    ...
    workdir: optional :class:`neuralset.infra.workdir.WorkDir`
        pydantic config defining whether and how to copy the current workspace to a directory specific for the job
        and avoid interferences when working on the code. See :class:`neuralset.infra.workdir.WorkDir` for details.
    name: optional str
        name of the job
